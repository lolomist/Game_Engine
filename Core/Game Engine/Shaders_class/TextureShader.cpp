...
TextureShader::TextureShader(VkExtent2D swapChainExtent, VkDevice device, VkRenderPass renderPass)
{
    _vertShaderPath = "shaders/textureShaderVert.spv";
    _fragShaderPath = "shaders/textureShaderFrag.spv";
...
VkDescriptorSetLayout TextureShader::getDescriptorSetLayout()
{
    return _descriptorSetLayout;
}

VkPipelineLayout TextureShader::getPipelineLayout()
{
    return _pipelineLayout;
}

VkPipeline TextureShader::getGraphicsPipeline()
{
    return _graphicsPipeline;
}

void TextureShader::createDescriptorSetLayout() {
...
void TextureShader::createGraphicsPipeline(VkExtent2D swapChainExtent, VkDevice device, VkRenderPass renderPass) {
...
void TextureShader::destroyPipeline()
{
    vkDestroyPipeline(_device, _graphicsPipeline, nullptr);
    vkDestroyPipelineLayout(_device, _pipelineLayout, nullptr);
}

void TextureShader::destroyDescriptorSetLayout()
{
    vkDestroyDescriptorSetLayout(_device, _descriptorSetLayout, nullptr);
}

VkShaderModule TextureShader::createShaderModule(const std::vector<char>& code) {
...
std::vector<char> TextureShader::readFile(const std::string& filename) {
