...
bool CheckCollision(float *object1, float *object2)
{
    ...
    for (int i = 0; i < (sizeof(object1) + 1); i = i + 9) {
        ...
        for (int x = 0; x < (sizeof(object2) + 1); x = x + 9) {
            ...
            float w1[3] = {(object1[i] - object2[x]), (object1[i] - object2[x]), (object1[i] - object2[x])};
            float w2[3] = {(object1[i + 3] - object2[x]), (object1[i + 3] - object2[x]), (object1[i + 3] - object2[x])};
            float w3[3] = {(object1[i + 6] - object2[x]), (object1[i + 6] - object2[x]), (object1[i + 6] - object2[x])};
