...
Utils::Utils(VkDevice device, VkPhysicalDevice physicalDevice, VkCommandPool commandPool, VkQueue graphicsQueue)
{
    _device = device;
...
void Utils::createImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory) {
...
void Utils::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
...
VkDevice Utils::getDevice()
{
    return _device;
}

VkPhysicalDevice Utils::getPhysicalDevice()
{
    return _physicalDevice;
}

VkCommandPool Utils::getCommandPool()
{
    return _commandPool;
}

VkQueue Utils::getGraphicsQueue()
{
