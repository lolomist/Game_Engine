...
TextureMapsShader::TextureMapsShader(VkExtent2D swapChainExtent, VkDevice device, VkRenderPass renderPass, bool isSpecular)
{
  /*  if (isSpecular == true) {
        ...
        _fragShaderPath = "shaders/textureSpecularShaderFrag.spv";
    }
    else {
        _vertShaderPath = "shaders/textureEffuseShaderVert.spv";
        _fragShaderPath = "shaders/textureEffuseShaderFrag.spv";
    }*/
...
TextureMapsShader::TextureMapsShader(VkExtent2D swapChainExtent, VkDevice device, VkRenderPass renderPass, bool isSpecular, bool isEffuse)
{
    if (isSpecular == true && isEffuse == true) {
        ...
        _vertShaderPath = "shaders/textureSpecularEffuseShaderVert.spv";
        _fragShaderPath = "shaders/textureSpecularEffuseShaderFrag.spv";
    }
    else {
        _vertShaderPath = "shaders/textureSpecularShaderVert.spv";
        _fragShaderPath = "shaders/textureSpecularShaderVert.spv";
    }
    _swapChainExtent = swapChainExtent;
    _device = device;
    _renderPass = renderPass;
...
{
    return _descriptorSetLayoutObjects;
}

//VkDescriptorSetLayout TextureMapsShader::getDescriptorSetLayoutLights()
//{
//    return _descriptorSetLayoutLights;
//}

VkPipelineLayout TextureMapsShader::getPipelineLayout()
{
    return _pipelineLayout;
}

VkPipeline TextureMapsShader::getGraphicsPipeline()
{
...
void TextureMapsShader::createGraphicsPipeline(VkExtent2D swapChainExtent, VkDevice device, VkRenderPass renderPass)
{
   ...
   /* VkDynamicState dynamicStates[] = {
    ...
    pipelineLayoutInfo.pSetLayouts = &_descriptorSetLayoutObjects;
...
void TextureMapsShader::createDescriptorSetLayout()
{
    createDescriptorSetLayoutObject();
    //createDescriptorSetLayoutLights();
}

void TextureMapsShader::destroyPipeline()
{
    vkDestroyPipeline(_device, _graphicsPipeline, nullptr);
    vkDestroyPipelineLayout(_device, _pipelineLayout, nullptr);
}

void TextureMapsShader::destroyDescriptorSetLayout()
{
    vkDestroyDescriptorSetLayout(_device, _descriptorSetLayoutObjects, nullptr);
}

VkShaderModule TextureMapsShader::createShaderModule(const std::vector<char>& code)
{
...
std::vector<char> TextureMapsShader::readFile(const std::string& filename)
{
...
void TextureMapsShader::createDescriptorSetLayoutObject()
{
    ...
    uboLayoutBinding.pImmutableSamplers = nullptr; // Optionnel
        ...
        samplerSpecLayoutBinding.descriptorCount = 1;
        ...
        VkDescriptorSetLayoutBinding samplerEmissionLayoutBinding{};
        samplerEmissionLayoutBinding.binding = 3;
        samplerEmissionLayoutBinding.descriptorCount = 1;
        samplerEmissionLayoutBinding.descriptorType = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
        samplerEmissionLayoutBinding.pImmutableSamplers = nullptr;
        samplerEmissionLayoutBinding.stageFlags = VK_SHADER_STAGE_FRAGMENT_BIT;

        std::array<VkDescriptorSetLayoutBinding, 4> bindings = { uboLayoutBinding, samplerLayoutBinding, samplerSpecLayoutBinding, samplerEmissionLayoutBinding };
        VkDescriptorSetLayoutCreateInfo layoutInfo{};
        layoutInfo.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_CREATE_INFO;
        layoutInfo.bindingCount = static_cast<uint32_t>(bindings.size());
        layoutInfo.pBindings = bindings.data();

        if (vkCreateDescriptorSetLayout(_device, &layoutInfo, nullptr, &_descriptorSetLayoutObjects) != VK_SUCCESS) {
            throw std::runtime_error("echec de la creation d'un set de descripteurs!");
        }
}

//void TextureMapsShader::createDescriptorSetLayoutLights()
//{
//    VkDescriptorSetLayoutBinding uboLayoutBinding{};
//    uboLayoutBinding.binding = 0;
//    uboLayoutBinding.descriptorType = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
...
//
//    if (vkCreateDescriptorSetLayout(_device, &layoutInfo, nullptr, &_descriptorSetLayoutLights) != VK_SUCCESS) {
//        throw std::runtime_error("echec de la creation d'un set de descripteurs!");
//    }
//}
