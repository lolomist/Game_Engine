...
ColorShader::ColorShader(VkExtent2D swapChainExtent, VkDevice device, VkRenderPass renderPass)
{
...
void ColorShader::createGraphicsPipeline(VkExtent2D swapChainExtent, VkDevice device, VkRenderPass renderPass)
{
