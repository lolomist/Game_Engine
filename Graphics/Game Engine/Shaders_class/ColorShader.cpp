...
ColorShader::ColorShader(VkExtent2D swapChainExtent, VkDevice device, VkRenderPass renderPass, VkSampleCountFlagBits msaaSamples)
{
    _vertShaderPath = "shaders/colorShaderVert.spv";
    _fragShaderPath = "shaders/colorShaderFrag.spv";
...
VkDescriptorSetLayout ColorShader::getDescriptorSetLayout()
{
    return _descriptorSetLayout;
}

VkPipelineLayout ColorShader::getPipelineLayout()
{
    return _pipelineLayout;
}

VkPipeline ColorShader::getGraphicsPipeline()
{
    return _graphicsPipeline;
}

void ColorShader::createGraphicsPipeline(VkExtent2D swapChainExtent, VkDevice device, VkRenderPass renderPass, VkSampleCountFlagBits msaaSamples)
{
...
void ColorShader::destroyPipeline()
{
    vkDestroyPipeline(_device, _graphicsPipeline, nullptr);
    vkDestroyPipelineLayout(_device, _pipelineLayout, nullptr);
}

void ColorShader::destroyDescriptorSetLayout()
{
    vkDestroyDescriptorSetLayout(_device, _descriptorSetLayout, nullptr);
}

void ColorShader::createDescriptorSetLayout()
{
    ...
    uboLayoutBindingFrag.stageFlags = VK_SHADER_STAGE_VERTEX_BIT | VK_SHADER_STAGE_FRAGMENT_BIT;
    uboLayoutBindingFrag.pImmutableSamplers = nullptr; // Optionnel

    VkDescriptorSetLayoutBinding binding = uboLayoutBindingFrag;
...
VkShaderModule ColorShader::createShaderModule(const std::vector<char>& code)
{
...
std::vector<char> ColorShader::readFile(const std::string& filename)
{
